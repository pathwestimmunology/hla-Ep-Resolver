...
ui <- fluidPage(
   ...
   sidebarLayout(
      sidebarPanel(
         ...
         helpText(h4(HTML("Required (recipient data)"))),
         ## MFI input
         fileInput(
            "mfi_upload",
            NULL,
         ...
         ## Add numeric input for MFI cut-off || apply to line 114 of the server.R
         helpText(h4(HTML("MFI threshold"))),
         fluidRow(
            column(
               10,
               numericInput(
            ...
            column(
               2,
               tags$i(
                  class = "glyphicon glyphicon-info-sign slim-info-icon",
                  title = "The default MFA threshold is ≥ 4000. Modify as needed with values above 500."
               )
            )
         ),
         tableOutput("output"),
         ...
         div(
            style = "margin: 0;",
            helpText(h4(HTML("Optional (donor data)"))),
            tags$div(
               class = "checkbox",
